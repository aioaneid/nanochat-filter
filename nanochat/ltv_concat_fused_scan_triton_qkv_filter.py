...
import nanochat.ops.ltv_triton_fused_scan  # Force execution of library.impl decorator


logger = logging.getLogger(__name__)


class LtvConcatFusedScanTritonQkvFilter(LtvCombinedQkvFilter):
    def forward(self, x, previous_values: LtvInitValues):
        ...
        with torch.amp.autocast(device_type=x.device.type, enabled=False):
            ...
            # The inputs to the triton kernel
            ...
            hq, hk, hv = torch.ops.nanochat.ltv_fused_scan_triton_op(
                q_inp,
                k_inp,
                v_inp,
                logits,
