...
void register_ltv_fused_concat_head_major_register_cast_blelloch_scan_cuda_backward(
    pybind11::module_ &m) {
  m.def(
      "ltv_fused_concat_head_major_register_cast_blelloch_scan_cuda_backward",
      &ltv_fused_concat_head_major_register_cast_blelloch_scan_cuda_backward_impl,
      "LTV Fused Concat Head-Major Register-Cast Blelloch Scan Backward "
      "(CUDA)");
}
