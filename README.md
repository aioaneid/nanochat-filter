...
The [training data set and tokenizer](https://anonymous-hf.up.railway.app/a/ks22v12bd6xr/) have been obtained by running [this part](https://github.com/karpathy/nanochat/blob/ae0bf525299633d973d39ecf996edcb48e1fa6f5/speedrun.sh#L1-L76) of the original `speedrun.sh` script.
